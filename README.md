...
As a homeowner, I want to check whether my property is suitable for solar panels, so that I can decide whether investing in solar is worthwhile.

As a small business owner, I want to calculate potential energy savings, so that I can understand the financial benefit of installing solar.

As a small business owner, I want to install solar panels, so that I can reduce electricity bills and increase profitability.

As a small business owner, I want to understand available grants and incentives, so that I can reduce installation costs.
...
**When** I enter my address and average energy bill
**I want to** see my estimated savings and return on investment.
...
**I want to** see the potential savings from making a bulk purchase.

### Business Owner

**Given** I am a business owner
**When** I enter information about my business and energy usage
**I want to** see my estimated carbon footprint.
...
**When** I enter my current energy usage and costs
**I want to** see how much I couuld save by installing solar panels.

**Given** I am a small business owner
**When** I decide to switch to solar
**I want to** understand how I can get solar panels installed.
